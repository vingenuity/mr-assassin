...
public class BountyListAdapter extends BaseAdapter
{
    private ArrayList<AssassinObj> list;
	private LayoutInflater mInflater;
 
    public BountyListAdapter(Context context, ArrayList<AssassinObj> list) 
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) 
    {
        ...
        sub.setText( "$" + Integer.toString( assassin.returnBounty() ) );
